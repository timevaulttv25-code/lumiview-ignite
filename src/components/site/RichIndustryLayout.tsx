...
export interface RichRelatedService {
  to: string;
  eyebrow: string;
  title: string;
  body: string;
...
export interface RichIndustryLayoutProps {
  // Hero
  heroEyebrow: string;
  heroTitle: string;
...
export function RichIndustryLayout(p: RichIndustryLayoutProps) {
  return (
    <SiteShell>
      <PageHero
      ...
      <section className="border-y border-border bg-secondary/30">
        <div className="container-prose py-20 lg:py-28">
          <div className="mb-12 max-w-3xl">
            <div className="eyebrow">{p.relatedEyebrow}</div>
            <h2 className="mt-3 font-serif text-3xl font-medium tracking-tight text-balance text-navy-deep lg:text-4xl">
              {p.relatedHeading}
            </h2>
          </div>
