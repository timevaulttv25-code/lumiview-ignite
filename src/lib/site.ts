...
export const SITE = {
  ...
  phoneDisplay: "(216) 939-LUMI (5864)",
  phoneNumeric: "(216) 939-5864",
  phoneLink: "tel:+12169395864",
  email: "connect@lumiviewservices.com",
  quotesEmail: "quotes@lumiviewservices.com",
  /** Inbound aliases for routing form submissions and per-page contact display. */
  emails: {
    general: "connect@lumiviewservices.com",
    care: "wecare@lumiviewservices.com",
    careers: "careers@lumiviewservices.com",
    partnerships: "partnerships@lumiviewservices.com",
    faq: "faq@lumiviewservices.com",
    referrals: "referrals@lumiviewservices.com",
    quotes: "quotes@lumiviewservices.com",
    quoteWindows: "windows@lumiviewservices.com",
    quotePressureWashing: "pressurewashing@lumiviewservices.com",
    quoteJanitorial: "janitorial@lumiviewservices.com",
    quoteAirbnb: "airbnb@lumiviewservices.com",
    quoteProperty: "property@lumiviewservices.com",
    quoteConstruction: "construction@lumiviewservices.com",
    quoteDaycare: "daycare@lumiviewservices.com",
  },
  address: {
    street: "Avon, OH",
    city: "Avon",
